...
if ($action == "reward-income") {
    include("reward-income.php");
    exit();
} else
   ...
   if ($action == "pair-count") {
    include("pair-count.php");
    exit();
} else 
   if ($action == "pair-income") {
    include("pair-income.php");
    exit();
} else 
   if ($action == "pin_count") {
...
$reward_income = $c_symbol . reward($user_id);
...
$total_income = $c_symbol . total_income($user_id);
...
$pair_income = $c_symbol . pair_income($user_id);
            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="myprofile-card col-md-12 col-lg-4">
                        ...
                        <!-- Card -->
                        <div class="p-0 mt-2 col-lg-12 col-md-12">
                            <div class="card border-bottom border-success">
                                <div class="card-body">
                                    <div class="d-flex no-block align-items-center">
                                        <div>
                                            <h2><?php echo $reward_income; ?></h2>
                                            <h6 class="text-success">Reward Income </h6>
                                        </div>
                                        <div class="ml-auto">
                                            <span class="text-success display-6"><i class="ti-wallet"></i></span>
                                        </div>
                                    </div>
                                    <a href="<?php echo $base_url . '/admin/user/' . $user_id . '/reward-income' ?>" class="mt-1 btn btn-primary">View All</a>
                                </div>
                            </div>
                        </div>
                        <!-- Card -->
                            ...
                            <div class="col-lg-6 col-md-6">
                                <div class=" card border-bottom border-success">
                                    <div class="card-body">
                                        ...
                                        <a href="<?php echo $base_url . '/admin/user/' . $user_id . '/incomes' ?>" class="mt-1 btn btn-primary">View All</a>
                                    </div>
                                </div>
                            </div>
                            <!-- Card -->
                            ...
                            <div class="col-lg-6 col-md-6">
                                <div class="card border-bottom border-success">
                                    <div class="card-body">
                                        <div class="d-flex no-block align-items-center">
                                            <div>
                                                <h2><?php echo $pair_count; ?></h2>
                                                <h6 class="text-success">Pair Count </h6>
                                            </div>
                                            <div class="ml-auto">
                                                <span class="text-success display-6"><i class=" icon-people "></i></span>
                                            </div>
                                        </div>
                                        <a href="<?php echo $base_url . '/admin/user/' . $user_id . '/pair-count' ?>" class="mt-1 btn btn-primary">View All</a>
                                    </div>
                                </div>
                            </div>
                            <!-- Card -->
                            ...
                            <div class="col-lg-6 col-md-6">
                                <div class="card border-bottom border-success">
                                    <div class="card-body">
                                        <div class="d-flex no-block align-items-center">
                                            <div>
                                                <h2><?php echo $pair_income; ?></h2>
                                                <h6 class="text-success">Pair Income </h6>
                                            </div>
                                            <div class="ml-auto">
                                                <span class="text-success display-6"><i class="ti-wallet"></i></span>
                                            </div>
                                        </div>
                                        <a href="<?php echo $base_url . '/admin/user/' . $user_id . '/pair-income' ?>" class="mt-1 btn btn-primary">View All</a>
                                    </div>
                                </div>
                            </div>
                            <!-- Card -->
