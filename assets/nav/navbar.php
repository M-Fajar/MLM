    ...
    <nav class="navbar top-navbar navbar-expand-md navbar-dark">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="<?php echo $base_url; ?>">
                ...
                <img src="<?php echo $base_url; ?>/assets/images/web/logo_white.png" alt="" width="60%">
                </span>
            </a>
    ...
    <div class="scroll-sidebar">
        <nav class="sidebar-nav">
            <ul id="sidebarnav">
                ...
                <li class="sidebar-item <?php if ((isset($active_tab)) && ($active_tab == 'rewards')) {
                                            echo 'active';
                                        } ?> ">
                    <a href="<?php echo $base_url; ?>/rewards/" class="sidebar-link waves-effect waves-dark" aria-expanded="false"><i class="cs-icon icon-badge"></i>
                ...
                <li class="sidebar-item has-nav-item">
                    ...
                    <ul aria-expanded="false" class="collapse first-level <?php if ((isset($page_tab)) && ($page_tab == 'income-history')) {
                        ...
                        <li class="sidebar-item <?php if ((isset($active_tab)) && ($active_tab == 'pair-income')) {
                                                    echo 'active';
                                                } ?> ">
                            <a href="<?php echo $base_url; ?>/income-history/pair-income.php" class="sidebar-link"><i style="font-size: 10px !important;" class="fas fa-circle"></i>
                                <span class="hide-menu">Pair Income </span>
                            </a>
                        </li>
                        ...
                        <li class="sidebar-item <?php if ((isset($active_tab)) && ($active_tab == 'reward-income')) {
                                                    echo 'active';
                                                } ?> ">
                            <a href="<?php echo $base_url; ?>/income-history/reward-income.php" class="sidebar-link"><i style="font-size: 10px !important;" class="fas fa-circle"></i>
                                <span class="hide-menu">Reward Income</span>
                            </a>
                        </li>
                        <li class="sidebar-item <?php if ((isset($active_tab)) && ($active_tab == 'generation-income')) {
                                                    echo 'active';
                                                } ?> ">
                            <a href="<?php echo $base_url; ?>/income-history/generation-income.php" class="sidebar-link"><i style="font-size: 10px !important;" class="fas fa-circle"></i>
