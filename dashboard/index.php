<?php
    ...
    $pair_income = pair_income($user_id);
                        ...
                        <div class="card border-bottom border-success">
                            <div class="card-body">
                                <div class="d-flex no-block align-items-center">
                                    <div>
                                        <h2><?php echo $c_symbol; ?><?php echo number_format($wallet); ?></h2>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="card border-bottom border-success">
                            <div class="card-body">
                                <div class="d-flex no-block align-items-center">
                                    <div>
                                        <h2><?php echo $c_symbol; ?><?php echo number_format($income); ?></h2>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="card border-bottom border-cyan">
                            <div class="card-body">
                                <div class="d-flex no-block align-items-center">
                                    <div>
                                        <h2><?php echo $c_symbol; ?><?php echo number_format($total_income); ?></h2>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="card border-bottom border-cyan">
                            <div class="card-body">
                                <div class="d-flex no-block align-items-center">
                                    <div>
                                        <h2><?php echo $c_symbol; ?><?php echo number_format($total_withdrawl); ?></h2>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="card border-bottom border-cyan">
                            <div class="card-body">
                                <div class="d-flex no-block align-items-center">
                                    <div>
                                        <h2><?php echo $c_symbol; ?><?php echo number_format($last_added_money); ?></h2>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="card border-bottom border-cyan">
                            <div class="card-body">
                                <div class="d-flex no-block align-items-center">
                                    <div>
                                        <h2><?php echo $c_symbol; ?><?php echo number_format($last_withdrawl_money); ?></h2>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="card border-bottom border-warning">
                            <div class="card-body">
                                <div class="d-flex no-block align-items-center">
                                    <div>
                                        <h2><?php echo $c_symbol; ?><?php echo number_format($reward); ?></h2>
                                        <h6 class="text-warning">Rewards</h6>
                                    </div>
                                    <div class="ml-auto">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="card border-bottom border-warning">
                            <div class="card-body">
                                <div class="d-flex no-block align-items-center">
                                    <div>
                                        <h2><?php echo $c_symbol; ?><?php echo number_format($pending); ?></h2>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="card border-bottom border-success">
                            <div class="card-body">
                                <div class="d-flex no-block align-items-center">
                                    <div>
                                        <h2><?php echo $c_symbol; ?><?php echo number_format($expenditure); ?></h2>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="card border-bottom border-cyan">
                            <div class="card-body">
                                <div class="d-flex no-block align-items-center">
                                    <div>
                                        <h2><?php echo $c_symbol; ?><?php echo number_format($pair_income); ?></h2>
