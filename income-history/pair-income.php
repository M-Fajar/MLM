            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 align-self-center">
                        <h4 class="page-title">Pair Income</h4>
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="#">Home</a></li>
                                    <li class="breadcrumb-item"><a href="#">Income History</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Pair Income</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table product-overview" id="data_table">
                                        ...
                                        <tbody>
                                            <?php echo show_pair_income_history($user_id); ?>
                                        </tbody>
                                    </table>
                                </div>
                            </div>
