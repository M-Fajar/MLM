    ...
    <footer class="py-5">
        <div class="pt-5 container text-center">
            ...
            <div class="pt-5 pb-5 social">
                <a href="https://tohaputra.com" title="Linkedin">
                    <i class="fab fa-linkedin-in"></i> </a>
                <a href="https://tohaputra.com" title="Youtbe">
                    <i class="fab fa-youtube"></i> </a>
                <a href="https://tohaputra.com" title="Facebok">
                    <i class="fab fa-facebook"></i> </a>
            </div>

            <!-- <p>Copyright © 2021 - Jamsrworld. All Rights Reserved.</p> -->
            <p>Copyright © 2021 - <a class="link" href="https://tohaputra.com">TohaPutra.com</a> All Rights Reserved.</p>
        </div>
    </footer>
