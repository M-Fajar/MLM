    ...
    if ($isValidChecksum == "TRUE") {
        if ($_POST["STATUS"] == "TXN_SUCCESS") {
            ...
            if ($db_status === 'inactive') {
                ...
                mysqli_query($conn, "UPDATE $balance_tbl SET wallet = wallet + $paid_amount, last_added_money = '$paid_amount' WHERE user_id = '$payer_user_id' ");
                mysqli_query($conn, "INSERT INTO $transaction_tbl ( `user_id`, `amount`, `transaction_charge`, `net_amount`, `description`, `date`, `status`)
                 VALUES('$payer_user_id','$paid_amount','0.00','$paid_amount','credit by paytm','$txn_date','credit') ");
            }
