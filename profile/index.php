...
$getAccountType = mysqli_query($conn, "SELECT * FROM $plan_tbl WHERE id = '$user_account_type'");
$gat = mysqli_fetch_array($getAccountType);

if($user_account_type == 0){
    $planName = 'No Subscribe Plan';
}
else {
    $planName = $gat['plan_name'];
}
?>
<!DOCTYPE html>
                            ...
                            <div class="card-body">
                                ...
                                <div class="user-information">
                                    ...
                                    <div class="information-data-row">
                                        ...
                                        <div>
                                            <span>QR Code</span>
                                            <span><img style="width: 100%;" src="<?php echo $user_account_image; ?>" alt=""></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
